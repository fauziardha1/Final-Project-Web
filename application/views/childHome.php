<div class="container" id="anak">
	...
	<div class="row">
		<div class="card mb-3 mr-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    ...
		    <div class="col-md-8">
		      <div class="card-body">
		        <a href="<?php echo base_url('jaket-anak')?>"><h5 class="card-title">Jaket</h5></a>
		...
		<div class="card mb-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    ...
		    <div class="col-md-8">
		      <div class="card-body">
		        <a href="<?php echo base_url('celana-anak')?>"><h5 class="card-title">Celana</h5></a>
		        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
		        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
		      </div>
		    </div>
	...
	<div class="row">
		<div class="card mb-3 mr-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    ...
		    <div class="col-md-8">
		      <div class="card-body">
		        <a href="<?php echo base_url('topi-anak')?>"><h5 class="card-title">Topi</h5></a>
		        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
		        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
		      </div>
		    </div>
		...
		<div class="card mb-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    ...
		    <div class="col-md-8">
		      <div class="card-body">
		        <a href="<?php echo base_url('sepatu-anak')?>"><h5 class="card-title">Sepatu</h5></a>
		        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
		        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
		      </div>
		    </div>
	...
	<div class="row">
		<div class="card mb-3 mr-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    <div class="col-md-4">
		      <a href="<?php echo base_url('jam-tangan-anak')?>">
		      	<img src="<?php echo base_url()?>img/childFashion/6.jpg" class="card-img" alt="...">
		      </a>
		    </div>
		    <div class="col-md-8">
		      <div class="card-body">
		        <a href="<?php echo base_url('jam-tangan-anak')?>"><h5 class="card-title">Jam Tangan</h5></a>
		        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
		        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
		      </div>
		    </div>
		...
		<div class="card mb-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    ...
		    <div class="col-md-8">
		      <div class="card-body">
		        <a href="<?php echo base_url('baju-anak')?>"><h5 class="card-title">Baju</h5></a>
		        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
		        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
		      </div>
		    </div>
