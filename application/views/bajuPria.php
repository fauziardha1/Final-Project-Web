<div class = "container-fluid ml-5 ">
		<div class="row text-center mt-5 ">
			<?php foreach ($baju_pria as $brg)  : ?>
				<div class="card ml-4 mb-5" style="width: 18rem; background-color:#F8F9F9;">
				  <img src="<?php echo base_url().'/img/menFashion/baju/' .$brg->gambar ?>" class="card-img-top" alt="...">
				  <div class="card-body">
